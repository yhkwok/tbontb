...
public class updateScore extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int itemToBeUpdateID = Integer.parseInt(request.getParameter("PollID"));
        ...
        String host = System.getenv("OPENSHIFT_MYSQL_DB_HOST");
            ...
            try {
                ...
                String sql = "Select score from userPollItems WHERE id=" + itemToBeUpdateID;
                ResultSet rs = stmt.executeQuery(sql);
                int currentScore = -1;//just to initialize
                ...
                //update the score
                currentScore += 1;
                sql = "UPDATE userPollItems " +
                        "SET score=" + currentScore +
                        "WHERE id=" + itemToBeUpdateID;
